...
async function handleError(ctx, error, labels) {
  ...
  ctx.metrics.erroredRequestsTotal.inc({
    ...labels,
    version: ctx.env.VERSION_METADATA.id ?? "privacy-pass-issuer@v0.1.0.next-dev+d58b68f"
  });
  ...
  buildContext(request, env, ectx) {
    ...
    if (!env.SENTRY_SAMPLE_RATE || parseFloat(env.SENTRY_SAMPLE_RATE) === 0) {
      ...
      logger2 = new FlexibleLogger(env.ENVIRONMENT, {
        ...
        release: "privacy-pass-issuer@v0.1.0.next-dev+d58b68f",
        service: env.SERVICE,
...
var handleTokenRequest = async (ctx, request) => {
  ctx.metrics.issuanceRequestTotal.inc({ version: ctx.env.VERSION_METADATA.id ?? "privacy-pass-issuer@v0.1.0.next-dev+d58b68f" });
