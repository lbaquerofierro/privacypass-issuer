...
export declare const issue: (ctx: Context, buffer: ArrayBuffer, domain: string, contentType?: string, prefix?: string) => Promise<{
	serialized: Uint8Array;
	status?: number;
	responseContentType: string;
}>;
export declare const handleTokenRequest: (ctx: Context, request: Request, prefix?: string) => Promise<Response>;
...
export declare const handleHeadTokenDirectory: (ctx: Context, request: Request, prefix?: string) => Promise<Response>;
export declare const handleTokenDirectory: (ctx: Context, request: Request, prefix?: string) => Promise<Response>;
export declare const handleRotateKey: (ctx: Context, request: Request, prefix?: string) => Promise<Response>;
export declare const handleClearKey: (ctx: Context, request?: Request | undefined, prefix?: string) => Promise<Response>;
